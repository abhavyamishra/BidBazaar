  ...
  return (
    <>
      <div
        ...
        className="fixed left-5 top-5 bg-[#D6482B] text-white text-3xl p-2 rounded-md hover:bg-[#b8381e]"
      >
        <GiHamburgerMenu />
      </div>
      <div
        ...
        // } transition-all duration-100 p-4 flex flex-col justify-between lg:left-0 border-r-[1px] border-r-stone-500`}
          className={`w-full sm:w-[300px] bg-[#f6f4f0] h-full fixed top-0 ${
            show ? "translate-x-0" : "-translate-x-full"
          } transition-all duration-300 ease-in-out p-4 flex flex-col justify-between lg:left-0 border-r border-stone-500 z-50`}
      >
        <div className="relative">
          ...
          className="absolute top-4 right-4 text-[32px] text-[#D6482B] hover:text-[#b8381e] cursor-pointer z-50"
          />
